...
export class GoService {
  ...
  public async init(
    ...
    this.logger.log('>>> initializing go project');
  ...
  public async build(
    ...
    this.logger.log('>>> Building go project');
  ...
  public async run(
    ...
    this.logger.log('>>> Running go project');
    throw new Error('Method not implemented.');
  }
  ...
  public async test(
    ...
    this.logger.log('>>> Testing go project');
    throw new Error('Method not implemented.');
  }
  ...
  public async clean(
    ...
    this.logger.log('>>> Cleaning go project');
    throw new Error('Method not implemented.');
  }
}
