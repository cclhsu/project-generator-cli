...
export class TypescriptService {
  ...
  public async init(
    ...
    this.logger.log('>>> initializing typescript project');
  ...
  public async build(
    ...
    this.logger.log('>>> Building typescript project');
  ...
  public async run(
    ...
    this.logger.log('>>> Running typescript project');
    throw new Error('Method not implemented.');
  }
  ...
  public async test(
    ...
    this.logger.log('>>> Testing typescript project');
    throw new Error('Method not implemented.');
  }
  ...
  public async clean(
    ...
    this.logger.log('>>> Cleaning typescript project');
    throw new Error('Method not implemented.');
  }
}
