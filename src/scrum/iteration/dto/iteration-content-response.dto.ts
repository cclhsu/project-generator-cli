...
export class IterationContentResponseDTO {
  constructor(ID: string, UUID: string, content: IterationContentDTO) {
    this.ID = ID;
    this.UUID = UUID;
  ...
  @ApiProperty({
    description: 'ID is Unique identifier for ' + IterationContentResponseDTO.name,
    example: 'john.doe',
  })
  ...
  @ApiProperty({
    description:
      ...
      ' for  ' +
      IterationContentResponseDTO.name,
