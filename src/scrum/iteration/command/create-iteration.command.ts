...
@SubCommand({
  name: 'create',
  description: 'A command to create a iteration',
})
export class CreateIterationCommand extends CommandRunner {
  private readonly logger = new Logger(CreateIterationCommand.name);
  constructor(
