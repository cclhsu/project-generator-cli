...
export class CreateMetricRequestDTO {
  ...
  @ApiProperty({
    description: 'ID is Unique identifier for ' + CreateMetricRequestDTO.name,
    example: 'john.doe',
  })
  ...
  readonly metadata: MetricMetadataDTO;

  @ApiProperty({
    description: 'Content of the metric.',
  })
