...
export class MetricContentResponseDTO {
  constructor(ID: string, UUID: string, content: MetricContentDTO) {
    this.ID = ID;
    this.UUID = UUID;
  ...
  @ApiProperty({
    description: 'ID is Unique identifier for ' + MetricContentResponseDTO.name,
    example: 'john.doe',
  })
