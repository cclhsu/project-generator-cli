...
export class MetricMetadataResponseDTO {
  constructor(ID: string, UUID: string, metadata: MetricMetadataDTO) {
    this.ID = ID;
    this.UUID = UUID;
  ...
  @ApiProperty({
    description: 'ID is Unique identifier for ' + MetricMetadataResponseDTO.name,
    example: 'john.doe',
  })
