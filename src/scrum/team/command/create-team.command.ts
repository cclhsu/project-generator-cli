...
export class CreateTeamCommand extends CommandRunner {
  ...
  async run(
    ...
    while (!team.content.scrumMaster) {
    ...
    try {
      this.logger.verbose(JSON.stringify(createTeamRequestDTO, null, 2));
