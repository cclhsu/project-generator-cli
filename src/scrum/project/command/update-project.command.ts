...
export class UpdateProjectCommand extends CommandRunner {
  ...
  async run(
    ...
    console.log(updateProjectRequestDTO);
...
// node ./dist/cmd.main project update --uuid 00000000-0000-0000-0000-000000000001
