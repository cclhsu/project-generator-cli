...
export class ProjectMetadataResponseDTO {
  constructor(ID: string, UUID: string, metadata: ProjectMetadataDTO) {
    this.ID = ID;
    this.UUID = UUID;
  ...
  @ApiProperty({
    description: 'ID is Unique identifier for ' + ProjectMetadataResponseDTO.name,
    example: 'john.doe',
  })
  ...
  @ApiProperty({
    description:
      ...
      ' for  ' +
      ProjectMetadataResponseDTO.name,
