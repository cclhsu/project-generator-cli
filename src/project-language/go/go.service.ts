...
export class GoService {
  ...
  public async init(
    ...
    this.logger.debug('>>> initializing go project');
    ...
    const projectLanguage: string =
      projectCommandOptionsDTO.projectLanguage || 'go';
  ...
  public async build(
    ...
    this.logger.debug('>>> Building go project');
  ...
  public async run(
    ...
    this.logger.debug('>>> Running go project');
    throw new Error('Method not implemented.');
  }
  ...
  public async test(
    ...
    this.logger.debug('>>> Testing go project');
    throw new Error('Method not implemented.');
  }
  ...
  public async clean(
    ...
    this.logger.debug('>>> Cleaning go project');
    throw new Error('Method not implemented.');
  }
}
